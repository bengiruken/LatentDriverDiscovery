...
class GENIE_MAF:
    ...
    def PreprocessingGenieMutationFile(self) :   
        ...
        #PATH = "/Users/bengi/Desktop/CommsBioRevision_Final_9Dec/REVISION#2/DATA_CODES_new"
        #OPTIONAL
        # df_mutation_final_.to_csv("OOP_Generated_GENIE_vol6_Mutation_Cleaned_Parsed_File__new.txt",sep="\t",index=False,header=True)
...
Dict = df.PatientTumorSampleOneToOneMatch()
AllDict = df.PatientSampleDictionary()
multiple = df.PatientsWithMultipleSamples()


Dict['GENIE-MSK-P-0003223']
AllDict['GENIE-MSK-P-0003223']
pats = df.all_patients()
('GENIE-MSK-P-0000525', 3)

('GENIE-MSK-P-0003329', 4)
len(df.all_patients())   
len(df.all_tumors())   
('GENIE-MSK-P-0002273', 3)
('GENIE-MSK-P-0003223', 4)
df.all_patients()    
